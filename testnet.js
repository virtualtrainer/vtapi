...
const treasuryId = AccountId.fromString(process.env.ACCOUNT_ID_2);
const treasuryKey = PrivateKey.fromString(process.env.PRIVATE_KEY_2);
const aliceId = AccountId.fromString(process.env.ACCOUNT_ID_3);
const aliceKey = PrivateKey.fromString(process.env.PRIVATE_KEY_3);
const bobId = AccountId.fromString(process.env.ACCOUNT_ID_4);
const bobKey = PrivateKey.fromString(process.env.PRIVATE_KEY_4);
...
async function main() {
	...
	CID = [
		"bafyreieyqfq7g26i5meysh2kfiumf7447mpyzvzstiazjisrquwht35wye",
		"bafyreieyqfq7g26i5meysh2kfiumf7447mpyzvzstiazjisrquwht35wye",
		"bafyreieyqfq7g26i5meysh2kfiumf7447mpyzvzstiazjisrquwht35wye",
		"bafyreieyqfq7g26i5meysh2kfiumf7447mpyzvzstiazjisrquwht35wye",
		"bafyreieyqfq7g26i5meysh2kfiumf7447mpyzvzstiazjisrquwht35wye",
	...
	new NftId(tokenId, mintRx.serials[0].toNumber());
    var nftInfos = await new TokenNftInfoQuery().setNftId(nftId).execute(client);
    console.log(` NFTInfoW: ${nftInfos}`);
