...
async function main() {
    ...
    var arr = new Uint8Array(["bafkreifjne3ner3iw7nikb3x66r2ib7emo6todkk3ltgnejcc4fcmnskga"]);
	// Mint new NFT
	let mintTx = await new TokenMintTransaction()
		.setTokenId(tokenId)
		.setMetadata([Buffer.from('bafkreifjne3ner3iw7nikb3x66r2ib7emo6todkk3ltgnejcc4fcmnskga')])
		.freezeWith(client);
